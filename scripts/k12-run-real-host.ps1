...
function Invoke-Pass {
    ...
    $artifact = Join-Path $runs "TASK-0026-K12-foundation-regression-webview2-pass$Pass.json"
    $abandoned = Join-Path $runs "TASK-0026-K12-foundation-regression-webview2-pass$Pass-abandon.json"
