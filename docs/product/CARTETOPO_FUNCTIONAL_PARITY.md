...
> **Clôture P-20 — ACTION-0075 (2026-09-25).** `P-20` est **CLOSED / VERIFIED** par composition de preuves indépendantes : `TASK-0018/ACTION-0029` (catalogue, isolation, même source, actif), `TASK-0038/ACTION-0064` (vu/non-vu brain-scoped), `TASK-0044/ACTION-0073` (vue/sélection/filtres/panneau restaurés sur trois cerveaux après redémarrage réel) et `TASK-0045/ACTION-0075` (nom/couleur/icône modifiables et persistants via l'UI). Aucun sous-critère nommé de P-20 ne reste ouvert.
...
> **Clôture P-21 — ACTION-0079 (2026-09-26).** `P-21` est **CLOSED / VERIFIED** par composition : `TASK-0046/ACTION-0077` ferme la langue FR/EN et sa persistance; `TASK-0047/ACTION-0079` ferme l'accessibilité dans la portée du contrat produit (audit axe dans WebView2 réel, parcours clavier sans piège, focus visible, contrastes, alternatives non colorées, reduced-motion). Les limites mesurées restent documentées; aucune certification WCAG générale n'est revendiquée.
